...
<div class="subheader py-2 py-lg-4  subheader-solid " id="kt_subheader">
    <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-2">
            ...
            <!--begin::Page Title-->
            <h5 class="text-dark font-weight-bold mt-2 mb-2"><a href="home" class="btn btn-clean font-weight-bold" style="color:#000;font-size:15px;">{{trans('layout.group')}}</a></h5>
            <!--end::Page Title-->

            <!--begin::Actions-->


            <span class="text-muted font-weight-bold mr-4">{{count($parentGroupList)}}</span>
            <!--end::Actions-->
        </div>
        <!--end::Info-->
                        ...
                        <div class="card-title">
                            <h3 class="card-label">
                                ...
                                <span class="d-block text-muted pt-2 font-size-sm">
                                    {{trans('layout.group')}}: {{count($parentGroupList)}}<span class="text-muted font-weight-bold mr-4"></span>
                                    {{trans('layout.subgroup')}}: {{$subGroupCount}}<span class="text-muted font-weight-bold mr-4"></span>
                                </span>
                            </h3>
                        </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{trans('layout.dlg_group')}}</h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    <label class="col-form-label col-2">{{trans('layout.parentgroup')}}<span class="text-danger">*</span></label>
                    <div class="col-4">
                        <select class="form-control" style="width:100%;" id="edit_group_parent" name="param" disabled>
...
<script type="text/javascript" src="frontend/js/group.js"></script>
@endsection
